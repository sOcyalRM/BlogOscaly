"""
Django settings for blogoscaly project.
...
SECRET_KEY = 'django-insecure-t5h0=-76(*ndgrhidrmrchlk*hacm00wo_yui3r9l80%gfasw8'
...
WSGI_APPLICATION = 'blogoscaly.wsgi.application'
